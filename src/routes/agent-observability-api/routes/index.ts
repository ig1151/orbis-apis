...
router.get('/discovery', (_req, res) => {
  res.json({
    ...
    pricing: { model: 'per_call', unit_cost_usd: 0.025, tier: 'infrastructure', tier_label: 'Autonomous Infrastructure', description: 'Agent telemetry and execution tracing infrastructure', },
