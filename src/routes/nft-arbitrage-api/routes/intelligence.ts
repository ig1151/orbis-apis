...
router.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    endpoints: [
      { method: 'POST', path: '/scan', summary: 'Floor price spread scan across NFT marketplaces for a collection', price_usdc: 0.005 },
      { method: 'POST', path: '/opportunities', summary: 'Market-wide NFT arb opportunities ranked by estimated profit', price_usdc: 0.005 },
      { method: 'POST', path: '/lookup', summary: 'ONE-CALL: full NFT arb with item analysis, rarity, gas, and liquidity risk', price_usdc: 0.015 },
    ],
