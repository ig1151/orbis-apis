...
export const config = {
  ...
  upload: { maxFileSizeMb: parseInt(optional('MAX_FILE_SIZE_MB', '10'), 10), allowedMimeTypes: ['application/pdf', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'text/plain'] as string[] },
