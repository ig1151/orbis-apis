...
router.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    endpoints: [
      { method: 'POST', path: '/scan', summary: 'Scan for market inefficiency signals across crypto, NFT, and DeFi', price_usdc: 0.006 },
      { method: 'POST', path: '/signals', summary: 'Ranked inefficiency signals with actionability rating', price_usdc: 0.008 },
      { method: 'POST', path: '/lookup', summary: 'ONE-CALL: full inefficiency analysis with root cause and exploitation strategy', price_usdc: 0.02 },
    ],
    pricing: { free_tier: { requests_per_day: 100, requests_per_month: 3000 }, pay_per_call: { scan: '$0.006', signals: '$0.008', lookup: '$0.02' } },
