...
const schemas = {
  EnvelopeOk, ExecutionMetadata, ConfidencePerSection: confSections('conversion', 'detection'), _Tail: Tail,
  AllCases, ConvertCore, DetectCore, ConvertRequest, DetectRequest, DiscoveryResponse: discoverySchema(),
