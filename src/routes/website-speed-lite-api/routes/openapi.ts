...
router.get('/', (_req, res) => {
  res.json({
    openapi: '3.0.0',
    info: {
      title: 'Agent website-speed-lite API',
      version: '1.0.0',
      description: 'Measure lightweight website speed, response time, and core performance signals',
      'x-agent-callable': true,
      'x-mcp-compatible': true,
      'x-monetization-grade': 'A',
      'x-pricing': {
        '/analyze': 0.004,
        '/analyze-website-speed-lite': 0.008,
        '/execution-gate': 0.004,
      },
      'x-rate-limits': { free: '100 req/day', builder: '50000 req/day', execution: '250000 req/day' },
    },
    servers: [{ url: 'https://orbis-apis.onrender.com/website-speed-lite', description: 'Production' }],
    components: {
    ...
    paths: {
      ...
      '/analyze-website-speed-lite': {
        post: {
          summary: 'ONE-CALL: Complete website-speed-lite intelligence workflow',
