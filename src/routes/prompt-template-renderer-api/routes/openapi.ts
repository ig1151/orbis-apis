...
const RenderCore = {
  type: 'object',
  required: ['variables_in_template', 'variables_provided', 'missing_variables', 'unused_variables', 'placeholder_count', 'unique_variable_count', 'all_resolved', 'missing_behavior', 'rendered', 'rendered_length'],
  properties: {
...
const CORE = {
  ...
  missing_variables: ['missing'], unused_variables: ['extra'],
  ...
  },
  {
    ...
    responseExample: {
      ...
      reasoning: {
        ...
        key_factors: ['Referenced: user.name, plan, missing.', 'Missing: missing.', 'missing_behavior=keep.'],
