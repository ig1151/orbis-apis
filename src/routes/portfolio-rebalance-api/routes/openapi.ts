...
router.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    security: [{ ApiKeyAuth: [] }],
    paths: {
      '/': { get: { operationId: 'portfolioRebalanceDiscovery', summary: 'API discovery — returns name, version, endpoints and capabilities', responses: { '200': { description: 'API discovery info' } } } },
