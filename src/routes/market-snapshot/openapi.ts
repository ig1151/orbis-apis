    ...
    paths: {
      ...
      '/quote': {
        get: { operationId: 'getQuote', summary: 'Get real-time stock quote', 'x-agent-callable': true,
          ...
          privacy: { type: 'object', description: 'Privacy metadata for this response' },
              ...
              fifty_two_week: { type: 'object', properties: {
          recommended_actions_priority_order: { type: 'array', items: { type: 'string' }, description: 'Ordered list of recommended next actions for the agent' },
          privacy: { type: 'object', description: 'Privacy metadata for this response' }, low: { type: 'string' }, high: { type: 'string' }, low_change_percent: { type: 'string' }, high_change_percent: { type: 'string' } } },
              timestamp: { type: 'string', format: 'date-time' },
              confidence_per_section: { type: 'object', properties: {
          recommended_actions_priority_order: { type: 'array', items: { type: 'string' }, description: 'Ordered list of recommended next actions for the agent' },
          privacy: { type: 'object', description: 'Privacy metadata for this response' }, quote: { type: 'number', minimum: 0, maximum: 1 } } },
            }},
        ...
        post: { operationId: 'postQuote', summary: 'Get quote via POST body', 'x-agent-callable': true,
          ...
          recommended_actions_priority_order: { type: 'array', items: { type: 'string' }, description: 'Ordered list of recommended next actions for the agent' },
          privacy: { type: 'object', description: 'Privacy metadata for this response' },
          confidence_per_section: { type: 'object', description: 'Per-section confidence scores (0-1)' }, quote: { type: 'number' } } },
            } },
      ...
      '/compare': { post: { operationId: 'compareSymbols', summary: 'Compare multiple tickers side by side ranked by performance', 'x-agent-callable': true,
        ...
        responses: { '200': { description: 'Comparison ranked by performance', content: { 'application/json': { schema: { type: 'object', properties: {
          ...
          confidence_per_section: { type: 'object', properties: {
          privacy: { type: 'object', description: 'Privacy metadata for this response' },
          confidence_per_section: { type: 'object', description: 'Per-section confidence scores (0-1)' }, comparison: { type: 'number' } } },
