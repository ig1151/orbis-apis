...
router.get('/discovery', (_req, res) => {
  res.json({
    ...
    pricing: { model: 'per_call', unit_cost_usd: 0.01, tier: 'platform', tier_label: 'Platform Intelligence', description: 'Statistical correlation and regime shift detection', },
