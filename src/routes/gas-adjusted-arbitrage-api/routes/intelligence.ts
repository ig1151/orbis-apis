...
router.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    endpoints: [
      { method: 'POST', path: '/estimate', summary: 'Gas cost estimate for a trade on a specific chain', price_usdc: 0.004 },
      { method: 'POST', path: '/scan', summary: 'All arb opportunities on a chain ranked by net profit after gas', price_usdc: 0.005 },
      { method: 'POST', path: '/lookup', summary: 'ONE-CALL: gas-adjusted analysis with optimal gas strategy and profit scenarios', price_usdc: 0.015 },
    ],
