...
router.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    endpoints: [
      { method: 'POST', path: '/spreads', summary: 'Price spreads for stablecoins across DEX and CEX venues', price_usdc: 0.004 },
      { method: 'POST', path: '/alerts', summary: 'Stablecoin arb alerts above spread threshold', price_usdc: 0.004 },
      { method: 'POST', path: '/lookup', summary: 'ONE-CALL: best stablecoin spread trade with peg risk context', price_usdc: 0.012 },
    ],
