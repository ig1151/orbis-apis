...
router.get('/discovery', (_req, res) => {
  res.json({
    ...
    pricing: { model: 'per_call', unit_cost_usd: 0.015, tier: 'infrastructure', tier_label: 'Autonomous Infrastructure', description: 'Pre-execution transaction simulation and risk surface', },
