...
router.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    endpoints: [
      { method: 'POST', path: '/scan', summary: 'Scan for viable triangular loops for a base currency', price_usdc: 0.005 },
      { method: 'POST', path: '/paths', summary: 'All detected arb paths on an exchange ranked by net profit', price_usdc: 0.005 },
      { method: 'POST', path: '/lookup', summary: 'ONE-CALL: best triangular loop with exact execution sequence', price_usdc: 0.015 },
    ],
