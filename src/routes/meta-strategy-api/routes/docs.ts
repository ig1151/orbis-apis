  ...
  paths: {
    ...
    '/scan': {
          ...
          '200': {
            ...
            content: { 'application/json': { schema: { type: 'object', properties: {
              ...
              data: { type: 'object', properties: {
                ...
                buySignals: { type: 'array', items: { type: 'object', properties: { symbol: { type: 'string' }, decision: { type: 'string' }, signalScore: { type: 'number' }, confidence: { type: 'number', minimum: 0, maximum: 1 } } } },
                sellSignals: { type: 'array', items: { type: 'object', properties: { symbol: { type: 'string' }, decision: { type: 'string' }, signalScore: { type: 'number' }, confidence: { type: 'number', minimum: 0, maximum: 1 } } } },
                holdSignals: { type: 'array', items: { type: 'object', properties: { symbol: { type: 'string' }, decision: { type: 'string' }, signalScore: { type: 'number' }, confidence: { type: 'number', minimum: 0, maximum: 1 } } } },
                bestBuy: { type: 'object', nullable: true, properties: { symbol: { type: 'string' }, decision: { type: 'string' }, signalScore: { type: 'number' }, confidence: { type: 'number', minimum: 0, maximum: 1 }, reasoning: { type: 'string' } } },
                bestSell: { type: 'object', nullable: true, properties: { symbol: { type: 'string' }, decision: { type: 'string' }, signalScore: { type: 'number' }, confidence: { type: 'number', minimum: 0, maximum: 1 }, reasoning: { type: 'string' } } },
      ...
      post: {
        ...
        responses: { '200': { description: 'Ranked signals', content: { 'application/json': { schema: { type: 'object', properties: {
          success: { type: 'boolean' },
          data: { type: 'object', properties: {
            scannedSymbols: { type: 'array', items: { type: 'string' } },
            scannedCount: { type: 'integer' },
            ...
            topOpportunity: { type: 'object', nullable: true, properties: { symbol: { type: 'string' }, decision: { type: 'string' }, signalScore: { type: 'number' }, confidence: { type: 'number', minimum: 0, maximum: 1 } } },
            ranked: { type: 'array', items: { type: 'object', properties: { symbol: { type: 'string' }, decision: { type: 'string', enum: ['BUY','STRONG_BUY','SELL','STRONG_SELL','HOLD'] }, signalScore: { type: 'number', minimum: -100, maximum: 100 }, confidence: { type: 'number', minimum: 0, maximum: 1 }, riskLevel: { type: 'string' }, reasoning: { type: 'string' }, rank: { type: 'integer' } } } },
            buySignals: { type: 'array', items: { type: 'object', properties: { symbol: { type: 'string' }, decision: { type: 'string' }, signalScore: { type: 'number' }, confidence: { type: 'number', minimum: 0, maximum: 1 } } } },
            sellSignals: { type: 'array', items: { type: 'object', properties: { symbol: { type: 'string' }, decision: { type: 'string' }, signalScore: { type: 'number' }, confidence: { type: 'number', minimum: 0, maximum: 1 } } } },
            analyzedAt: { type: 'string', format: 'date-time' },
          }},
    ...
    '/execution-gate': {
      post: {
        ...
        responses: { '200': { description: 'Gate decision', content: { 'application/json': { schema: { type: 'object', properties: {
          ...
          top_opportunity: { type: 'object', nullable: true, properties: { symbol: { type: 'string' }, decision: { type: 'string' }, confidence: { type: 'number', minimum: 0, maximum: 1 } } },
          recommended_actions_priority_order: { type: 'array', items: { type: 'string' } },
          chain_to: { type: 'array', items: { type: 'string' } },
          privacy: { type: 'object', properties: { data_stored: { type: 'boolean' }, retention: { type: 'string' } } },
        } } } } } },
