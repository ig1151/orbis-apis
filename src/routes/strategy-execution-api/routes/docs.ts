...
<head>
  ...
  <title>Strategy Execution API</title>
  <style>
...
<body>
  <h1>Strategy Execution API</h1>
  <p>AI strategy engine that orchestrates news, signals and portfolio data into actionable trade decisions.</p>
  <h2>Endpoints</h2>
  <table>
    <tr><th>Method</th><th>Path</th><th>Description</th></tr>
    <tr><td><span class="badge post">POST</span></td><td>/v1/strategy/execute</td><td>Execute a strategy and get actions</td></tr>
    <tr><td><span class="badge post">POST</span></td><td>/v1/strategy/backtest</td><td>Backtest across bear/neutral/bull scenarios</td></tr>
    <tr><td><span class="badge get">GET</span></td><td>/v1/strategy/list</td><td>List available strategies</td></tr>
    <tr><td><span class="badge get">GET</span></td><td>/v1/health</td><td>Health check</td></tr>
  </table>
  <h2>Example Request</h2>
  <pre>POST /v1/strategy/execute
