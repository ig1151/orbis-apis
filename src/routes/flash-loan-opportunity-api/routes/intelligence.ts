...
router.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    endpoints: [
      { method: 'POST', path: '/protocols', summary: 'Available flash loan protocols with liquidity and fees', price_usdc: 0.005 },
      { method: 'POST', path: '/scan', summary: 'Detected flash loan arb opportunities with net profit', price_usdc: 0.01 },
      { method: 'POST', path: '/lookup', summary: 'ONE-CALL: full flash loan execution plan with step-by-step execution', price_usdc: 0.025 },
    ],
    pricing: { free_tier: { requests_per_day: 100, requests_per_month: 3000 }, pay_per_call: { protocols: '$0.005', scan: '$0.01', lookup: '$0.025' } },
