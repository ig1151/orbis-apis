...
router.get('/discovery', (_req, res) => {
  res.json({
    ...
    pricing: { model: 'per_call', unit_cost_usd: 0.01, tier: 'platform', tier_label: 'Platform Intelligence', description: 'Transcript analysis, diarization, and insight extraction', },
