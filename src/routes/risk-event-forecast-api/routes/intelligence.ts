...
Return JSON:
{
  ...
  "distribution": { "p10": "string (optimistic scenario probability)", "p50": "string (base case probability)", "p90": "string (pessimistic scenario probability)" },
...
Return JSON:
{
  ...
  "distribution": { "p10": "string (low vol scenario)", "p50": "string (base vol scenario)", "p90": "string (high vol scenario)" },
...
router.post('/execution-gate', async (req: Request, res: Response) => {
  ...
  res.json({
    ...
    blocking_flags: [],
    recommended_next_api: 'portfolio-risk',
...
Return JSON:
{
  ...
  "risk_distribution": { "p10": "string (bull case risk score)", "p50": "string (base case risk score)", "p90": "string (bear case risk score)" },
