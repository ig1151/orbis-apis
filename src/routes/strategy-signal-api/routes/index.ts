...
router.get('/discovery', (_req, res) => {
  res.json({
    ...
    pricing: { model: 'per_call', unit_cost_usd: 0.018, tier: 'infrastructure', tier_label: 'Autonomous Infrastructure', description: 'Multi-factor quantitative strategy signal generation', },
