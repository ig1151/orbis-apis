...
router.get('/', (_req, res) => {
  res.json({
    openapi: '3.0.0',
    info: {
      title: 'Agent market-signal-v2 API',
      version: '1.0.0',
      description: 'Real-time stock market signal scoring and portfolio intelligence for AI agents',
      'x-agent-callable': true,
      'x-mcp-compatible': true,
      'x-monetization-grade': 'A',
      'x-pricing': {
        '/analyze': 0.004,
        '/analyze-market-signal-v2': 0.008,
    ...
    paths: {
      ...
      '/analyze-market-signal-v2': {
        post: {
          summary: 'ONE-CALL: Complete market-signal-v2 intelligence workflow',
