...
router.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    endpoints: [
      { method: 'POST', path: '/scan', summary: 'DEX vs CEX price gap scan for a token', price_usdc: 0.005 },
      { method: 'POST', path: '/alerts', summary: 'Active DEX/CEX arb opportunities above threshold', price_usdc: 0.004 },
      { method: 'POST', path: '/lookup', summary: 'ONE-CALL: full DEX/CEX arb analysis with execution checklist', price_usdc: 0.015 },
    ],
