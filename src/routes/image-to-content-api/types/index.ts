...
export interface ConfidencePerSection { caption?: number | null; tags?: number | null; ocr?: number | null; faces?: number | null; layout?: number | null; table_extraction?: number | null; entity_detection?: number | null; semantic?: number | null; extraction_completeness?: number | null; }
export interface VisualReasoning { document_consistency?: number; contradiction_detected: boolean; visual_text_alignment_score?: number | null; semantic_anomaly_detected: boolean; layout_anomalies?: string[]; cross_section_conflicts?: string[]; semantic_warnings?: string[]; reasoning_summary: string; }
export interface Provenance { model: string; extraction_method: string; modules_applied: string[]; page: number; section: string; coordinates: null | number[]; trace_id: string; }
export interface AnalyzeResponse { id: string; execution_id?: string; session_id?: string | null; status: JobStatus; model: string; caption?: CaptionResult; summary?: SummaryResult; tags?: TagResult[]; metadata?: MetadataResult; sentiment?: SentimentResult; ocr?: OcrResult; faces?: FacesResult; confidence_per_section?: ConfidencePerSection; visual_reasoning?: VisualReasoning; provenance?: Provenance; workflow_state?: string; retryable?: boolean; orchestration_hints?: Record<string, any>; latency_ms: number; usage: UsageResult; created_at: string; }
