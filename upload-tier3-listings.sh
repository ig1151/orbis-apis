#!/bin/bash
# Upload Tier 3 crypto API listings to Orbis (8 APIs)
# Usage: ORBIS_API_KEY=your_key bash upload-tier3-listings.sh
...
INPUT="tier3-crypto-listings-upload.json"

echo "Uploading 8 Tier 3 crypto API listings from $INPUT..."
echo ""
...
data = json.load(open("tier3-crypto-listings-upload.json"))
