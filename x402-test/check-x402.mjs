...
const tests = [
  ...
  { slug: "agent-market-signal-portfolio-intelligence-api-4cbef1",         path: "/batch",                 body: { assets: ["AAPL", "MSFT"] } },
  ...
  { slug: "defi-risk-api-3103dd",                                           path: "/",                      body: { token: "bitcoin", type: "token" } },
  { slug: "yield-farming-api-69fdc7",                                       path: "/yields/top",            body: { limit: 5 } },
  { slug: "tokenomics-api-4e766b",                                          path: "/tokenomics",            body: { token: "bitcoin" } },
  { slug: "crypto-narrative-api-51cb0e",                                    path: "/",                      body: { type: "trending", limit: 5 } },
  ...
  { slug: "market-intelligence-api-d3405e",                                 path: "/",                      body: { ticker: "BTC" } },
  ...
  { slug: "token-screener-api-344276",                                      path: "/",                      body: { type: "gainers", limit: 5 } },
  { slug: "gas-optimizer-api-4f7b83",                                       path: "/",                      body: { chain: "ethereum" } },
  { slug: "funding-rate-api-f2559c",                                        path: "/",                      body: { symbol: "BTC" } },
  { slug: "prediction-market-api-4181e0",                                   path: "/",                      body: { type: "trending", limit: 5 } },
  { slug: "social-sentiment-api-b5129e",                                    path: "/",                      body: { symbol: "BTC" } },
  ...
  { slug: "stablecoin-yield-api-2f7fbc",                                    path: "/",                      body: { token: "USDC", limit: 5 } },
  { slug: "meta-strategy-api-bd99c8",                                       path: "/",                      body: { assets: ["BTC", "ETH"], window: "7d" } },
  { slug: "token-unlock-api-f1f131",                                        path: "/",                      body: { lookahead_days: 7 } },
  { slug: "wallet-portfolio-api-414e10",                                    path: "/",                      body: { address: "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045" } },
  ...
  { slug: "image-to-content-api-5c7f80",                                    path: "/analyze",               body: { image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/PNG_transparency_demonstration_1.png/240px-PNG_transparency_demonstration_1.png", modules: ["caption", "tags"] } },
  ...
  { slug: "text-generation-api-8c1608",                                     path: "/v1/text/generate",      body: { prompt: "Say hello in one sentence.", provider: "auto" } },
