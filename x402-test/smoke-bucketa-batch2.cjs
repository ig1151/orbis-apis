...
async function run(base) {
  ...
  check('web-content-freshness-scorer', 'POST /score (stale)', 'ScoreResponse', (await call(base, 'POST', '/web-content-freshness-scorer/score', { published_date: '2025-01-01', modified_date: '2025-06-01', as_of: '2026-06-11', half_life_days: 180 })).json, d => d.band === 'stale' && d.was_updated === true && Math.abs(d.age_days - 375) < 1 ? null : `unexpected band ${d.band} age ${d.age_days}`);
