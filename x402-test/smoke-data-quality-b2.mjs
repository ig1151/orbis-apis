// Smoke + drift guard for Data-Quality batch 2.
...
const SLUGS = ['data-normalizer', 'data-mapper', 'data-transformer', 'data-aggregator', 'data-classification'];
...
// 3) error paths → 400
const errs = [
  ['data-normalizer/normalize', { rows: [{ a: 1 }] }],
  ['data-mapper/map', { rows: [{ a: 1 }] }],
  ['data-transformer/transform', { rows: [{ a: 1 }] }],
  ['data-aggregator/aggregate', { rows: [{ a: 1 }] }],
